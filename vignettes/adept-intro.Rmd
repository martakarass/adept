...
"maxima" fine-tune procedure tunes preliminarily identified locations of pattern occurence beginning and end so as they correspond to local maxima of time-series `x` (or smoothed version of `x`, as we shall see later) found within neighbourhoods of preliminary locations. 
